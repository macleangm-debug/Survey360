        ...
        <DialogContent className="bg-[#0f1d32] border-white/10 max-w-lg">
          ...
          <Tabs defaultValue="link" className="w-full">
            ...
            <TabsContent value="link" className="mt-4 space-y-4">
              ...
              <Button
                variant="outline"
                onClick={() => shortenLink(getPublicUrl())}
                disabled={shorteningUrl === getPublicUrl()}
                className="w-full border-white/10 text-gray-300 hover:bg-white/5"
              >
                {shorteningUrl === getPublicUrl() ? (
                  <>
                  ...
                  <>
                    ...
                    {shortenedLinks[getPublicUrl()] ? 'Copy Short Link' : 'Shorten & Copy'}
                  </>
                )}
              </Button>
...
></iframe>`}
                  ...
                  <Button 
                    size="sm"
                    onClick={() => copyToClipboard(`<iframe src="${getPublicUrl()}" width="100%" height="600" frameborder="0" style="border: none; border-radius: 8px;" title="${survey.name}"></iframe>`, 'embed')}
